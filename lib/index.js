...
exports.search = function (params, cb, cookie) {
  const url = utils.generateSearchUrl(params)
  req({ url, headers: { Cookie: cookie } }, function (error, html) {
    if (error) {
      cb(error, null)
    } else {
...
exports.getAlbumsWithTag = function (params, cb, cookie) {
...
exports.getAlbumUrls = function (artistUrl, cb, cookie) {
  artistUrl = new urlHelper.URL('/music', artistUrl).toString()
  req({ url: artistUrl, headers: { Cookie: cookie } }, function (error, html) {
    if (error) {
      cb(error, null)
    } else {
      if (checkNotFound(html)) return cb(new Error('404'), null)
...
exports.getAlbumInfo = function (albumUrl, cb, cookie) {
  req({ url: albumUrl, headers: { Cookie: cookie } }, function (error, html) {
    if (error) {
      cb(error, null)
    } else {
      if (checkNotFound(html)) return cb(new Error('404'), null)
...
exports.getAlbumProducts = function (albumUrl, cb, cookie) {
  req({ url: albumUrl, headers: { Cookie: cookie } }, function (error, html) {
    if (error) {
      cb(error, null)
    } else {
...
exports.getArtistUrls = function (labelUrl, cb, cookie) {
  labelUrl = new urlHelper.URL('/artists', labelUrl).toString()
  req({ url: labelUrl, headers: { Cookie: cookie } }, function (error, html) {
    if (error) {
      cb(error, null)
    } else {
      if (checkNotFound(html)) return cb(new Error('404'), null)
...
exports.getArtistInfo = function (artistUrl, cb, cookie) {
  req({ url: artistUrl, headers: { Cookie: cookie } }, function (error, html) {
    if (error) {
      cb(error, null)
    } else {
...
exports.getTrackInfo = function (trackUrl, cb, cookie) {
  req({ url: trackUrl, headers: { Cookie: cookie } }, function (error, html) {
    if (error) {
      cb(error, null)
    } else {
      if (checkNotFound(html)) return cb(new Error('404'), null)
